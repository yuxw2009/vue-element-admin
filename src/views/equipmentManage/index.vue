<template>
  <div class="app-container" style="height:100%">
    ...
    <el-form :inline="true" :model="listQuery" class="demo-form-inline" id='box'>
      <el-form-item label="设备编号">
        <el-input size="small" v-model="listQuery.equipmentNO" placeholder="设备编号"></el-input>
      </el-form-item>
      <el-form-item label="SIM卡号">
        <el-input size="small" v-model="listQuery.simcard" placeholder="SIM卡号"></el-input>
      </el-form-item>
    
    <el-form-item label="安装位置">
        <el-input size="small" v-model="listQuery.location" placeholder="安装位置"></el-input>
      </el-form-item>
    
    <el-form-item label="安装地址">
        <el-input size="small" v-model="listQuery.address" placeholder="安装地址"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button size="small" type="primary" @click="onSubmit">查询</el-button>
      </el-form-item>
    </el-form>
    <el-table ref="crudTable" v-loading="listLoading" :data='maps'  :height='tableHeight' id='table' border  > 
      ...
      <el-table-column align="center" label="设备编号" prop="equipmentNO" class="el-table-column" width="250"></el-table-column>
      <el-table-column align="center" label="sim卡号" prop="simcard" class="el-table-column" width="300"></el-table-column>
      <el-table-column align="center" label="客户名称" prop="clientele" class="el-table-column" width="300"></el-table-column>
      <!-- <el-table-column align="center" label="uset" prop="uset" class="el-table-column" width="250"></el-table-column> -->
      <el-table-column align="center" label="产品型号" prop="volume" class="el-table-column" width="250"></el-table-column>
      <el-table-column align="center" label="安装地址" prop="address" class="el-table-column" width="250"></el-table-column>
      <el-table-column align="center" label="安装位置" prop="location" class="el-table-column" width="250"></el-table-column>
      <el-table-column align="center" label="滤芯信息" prop="filters" class="el-table-column" width="500">
        ...
        <el-table-column align="center" label="总用水量" prop="detail.totalFlow" class="el-table-column"></el-table-column>
          ...
          response.data.forEach((detail,i)=>{
            for(let i=0; i <this.maps.length; i++) {
              if(detail.equipmentNo == this.maps[i].equipmentNO) {
                let strTemp = detail.totalFlow.split(",")
